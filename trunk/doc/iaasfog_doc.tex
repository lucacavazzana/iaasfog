...
\noindent La seconda seconda parte, sviluppata in Matlab per sfruttare le funzioni di fitting, calcola il $\lambda$ globale come la media dei parametri stimati delle migliori sequenze di dati, illustrato in dettaglio nella sottosezione \ref{sect:fit}.\\
...
\begin{figure}[H]
	...
	\label{diag:high}
	\caption{A sinistra: fase di estrazione di $\lambda$ mediante fittig. A destra: approccio alternativo basato su RANSAC.}
\end{figure}
