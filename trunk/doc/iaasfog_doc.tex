...
\begin{minipage}[t]{0.5\linewidth}
	\centering
	\includegraphics[scale=\imFeat]{images/ransac1}\\
	\includegraphics[scale=\imFeat]{images/ransac3}\\
	\includegraphics[scale=\imFeat]{images/ransac5}\\
\end{minipage}
\begin{minipage}[t]{0.5\linewidth}
	\centering
	\includegraphics[scale=\imFeat]{images/ransac2}\\
	\includegraphics[scale=\imFeat]{images/ransac4}\\
	\includegraphics[scale=\imFeat]{images/ransac6}\\
\end{minipage}
\caption[short]{Iterazioni di RANSAC. In blu i dati, in giallo le curva candidata, in rosso i campioni del relativo modello.}
\label{fig:ransac1}
\end{figure}
...
\begin{minipage}[t]{0.5\linewidth}
	\centering
	\includegraphics[scale=\imFeat]{images/ransac7}\\
	\includegraphics[scale=\imFeat]{images/ransac9}\\
	\includegraphics[scale=\imFeat]{images/ransac11}\\
\end{minipage}
\begin{minipage}[t]{0.5\linewidth}
	\centering
	\includegraphics[scale=\imFeat]{images/ransac8}\\
	\includegraphics[scale=\imFeat]{images/ransac10}\\
	\includegraphics[scale=\imFeat]{images/ransac12}\\
\end{minipage}
\caption[short]{Iterazioni di RANSAC. In blu i dati, in giallo le curva candidata, in rosso i campioni del relativo modello.}
\label{fig:ransac2}
\end{figure}
