...
\noindent Esaminando invece i tempi di calcolo si nota che sono sostanzialmente simili: mentre il primo algoritmo richiede due fit per ogni feature, RANSAC ne richiede solo uno per la normalizzazione iniziale pi\`u un fit per ogni modello provato.\\
