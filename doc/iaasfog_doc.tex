...
\begin{figure}[H]
	...
	\label{diag:high}
	\caption{A sinistra: fase di calcolo di $\lambda$ mediante fittig. A destra, ombreggiato: approccio alternativo basato su RANSAC.}
\end{figure}
